...
def run(cfg):
    ...
    for i in range(LOOKBACK, len(all_bars) - 2):
        ...
        sig = strategy104.detect_s104(rates_slice, tf=TF, dt_bkk=dt_bkk, cfg=cfg)
...
variants = [
    ("p2+retr38", {"SWING_LEFT": 2, "SWING_RIGHT": 2, "ENTRY_RETRACE": 0.38}),
    ("p4+retr38", {"SWING_LEFT": 4, "SWING_RIGHT": 4, "ENTRY_RETRACE": 0.38}),
    ("p4+retr38+rr4", {"SWING_LEFT": 4, "SWING_RIGHT": 4, "ENTRY_RETRACE": 0.38, "TP_RR": 4.0}),
    ("p2+retr38+d05", {"SWING_LEFT": 2, "SWING_RIGHT": 2, "ENTRY_RETRACE": 0.38, "DISP_BODY_ATR": 0.5}),
    ("p4+d05", {"SWING_LEFT": 4, "SWING_RIGHT": 4, "DISP_BODY_ATR": 0.5}),
    ("p4+retr38+trail", {"SWING_LEFT": 4, "SWING_RIGHT": 4, "ENTRY_RETRACE": 0.38,
                         "TRAIL_ENABLED": True, "TRAIL_BE_RR": 1.5, "TRAIL_ATR_MULT": 2.5}),
]
