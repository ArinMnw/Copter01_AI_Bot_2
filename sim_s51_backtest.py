"""
sim_s51_backtest.py — Backtest S51 (Previous Day High/Low bounce)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⚠️ RESEARCH / BACKTEST-ONLY — ไม่แก้ S1-S50, ไม่ wire เข้า live
"""
...
def _cfg_get(cfg, key):
    return cfg[key] if (cfg and key in cfg) else S51_DEFAULTS[key]


def replay51(bars, htf_series, spread, cfg):
    ...
    for j in range(start_j, n - 1):
        ...
        res = detect_s51(window, tf=cfg["ENTRY_TF"], dt_bkk=dt_bkk, cfg=cfg, htf_ctx=htf_ctx,
...
def run_single(entry_bars, htf_bars, cfg, days, spread):
    ...
    return replay51(entry_bars, htf_series, spread, cfg)
...
def append_summary_csv(label, s, cfg):
    path = os.path.join(os.path.dirname(__file__), "s51_backtest_summary.csv")
...
def main():
    ...
    ap.add_argument("--risk", type=float, default=S51_DEFAULTS["RISK_PCT"])
    ...
    print(f"S51 backtest | days={args.days} | risk={cfg['RISK_PCT']}% | touch={cfg['TOUCH_ATR_MULT']} "
