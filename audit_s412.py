# -*- coding: utf-8 -*-
"""Final reproducible cross-window, spread, and payload audit for S412."""

from datetime import datetime

from sim_strategy_backtest import backtest, parse_bkk, prepare_rates
from strategy412 import detect_s412
...
def main():
    for name, months, end_text in WINDOWS:
        ...
        for spread in (0.20, 0.50):
            summary, trades = backtest(412, months, "M5", spread, 0.01,
            ...
            if spread == 0.20 and name == "h1" and trades:
                ...
                for index, bar in enumerate(bars):
                    if int(bar["time"]) == int(target.timestamp()):
                        print("payload_smoke", detect_s412(
