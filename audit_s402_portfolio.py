# -*- coding: utf-8 -*-
"""Parallel overlap, risk-distance, and portfolio audit for S402."""
...
BASE_IDS = (346, 349, 351, 355, 358, 359, 361, 362, 363, 365, 366, 367,
            ...
            384, 385, 386, 387, 389, 393, 394, 396, 398, 399, 401)
WINDOWS = (
...
def main():
    by_sid = {sid: [] for sid in (*BASE_IDS, 402)}
    h1_trades = {}
    risks = []
    ...
    target_times = {trade["signal_time"] for trade in h1_trades[402]}
    overlap = {
    ...
    after = before + by_sid[402]
    print("overlap", overlap)
    print("risk", {"min": min(risks), "median": median(risks), "max": max(risks)})
    print("s402_wf_h1", _stats(by_sid[402]))
    print("portfolio_before", _stats(before))
    for weight in (0.25, 0.50, 0.75):
        weighted = before + [
            (stamp, profit * weight) for stamp, profit in by_sid[402]
        ]
