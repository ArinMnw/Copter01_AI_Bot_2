# -*- coding: utf-8 -*-
"""Fast exact payoff and breakeven sweep for S275."""
...
from strategy275 import detect_s275
from sweep_s235_payoff import _summary_market


RR_VALUES = (20.8, 20.9)
BE_VALUES = tuple(round(1.40 + 0.01 * index, 2) for index in range(31))
...
def main():
    ...
    for index in range(start_index, len(bars) - 1):
        ...
        signal = detect_s275(window, "M5", dt_bkk, base_cfg)
        validate_signal(signal, 275)
        cached[index] = signal
    rows = [
