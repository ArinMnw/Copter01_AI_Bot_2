# -*- coding: utf-8 -*-
"""Parallel overlap, risk-distance, and portfolio audit for S387."""
...
def main():
    by_sid = {sid: [] for sid in (*BASE_IDS, 387)}
    h1_trades = {}
    risks = []
    ...
    target_times = {trade["signal_time"] for trade in h1_trades[387]}
    overlap = {
