...
parser = argparse.ArgumentParser(description="Backtest S103 Sideways Mean-Reversion")
parser.add_argument("--days", type=int, default=90)
parser.add_argument("--start", type=str, help="YYYY-MM-DD")
parser.add_argument("--end", type=str, help="YYYY-MM-DD")
parser.add_argument("--fill-bars", type=int, default=5, help="For limit entry mode")
parser.add_argument("--cooldown", type=int, default=10)
parser.add_argument("--tf", type=str, default="M1")
parser.add_argument("--out-prefix", type=str, default="s112")
...
for i in range(LOOKBACK, len(all_bars) - 2):
    ...
    sig = strategy112.detect_s112(rates_slice, tf=TF, dt_bkk=dt_bkk, cfg=cfg)
