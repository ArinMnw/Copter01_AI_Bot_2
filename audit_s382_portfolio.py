# -*- coding: utf-8 -*-
"""Overlap, risk-distance, and incremental portfolio audit for S382."""
...
BASE_IDS = (346, 349, 351, 355, 358, 359, 361, 362, 363, 365, 366, 367,
            369, 370, 371, 372, 373, 374, 375, 376, 378, 379, 380)
WINDOWS = (
...
def main():
    by_sid = {sid: [] for sid in (*BASE_IDS, 382)}
    h1_trades = {}
    risks = []
    for name, months, end_text in WINDOWS:
        end = parse_bkk(end_text)
        prepared = prepare_rates(months, "M5", end, 300)
        for sid in (*BASE_IDS, 382):
            _, trades = backtest(
                sid,
                months,
                "M5",
    ...
    target_times = {trade["signal_time"] for trade in h1_trades[382]}
    overlap = {
