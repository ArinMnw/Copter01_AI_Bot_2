...
def run(cfg):
    ...
    for i in range(LOOKBACK, len(all_bars) - 2):
        ...
        sig = strategy110.detect_s110(rates_slice, tf=TF, dt_bkk=dt_bkk, cfg=cfg)
...
variants = [
    ("rr1.5 (ref)", {"TP_RR": 1.5}),
    ("rr1.5+retr62", {"TP_RR": 1.5, "ENTRY_RETRACE": 0.62}),
    ("rr1.5+retr38", {"TP_RR": 1.5, "ENTRY_RETRACE": 0.38}),
    ("rr1.2", {"TP_RR": 1.2}),
    ("rr1.5+leg3", {"TP_RR": 1.5, "MIN_LEG_ATR": 3.0}),
    ("rr1.5+leg1.5", {"TP_RR": 1.5, "MIN_LEG_ATR": 1.5}),
    ("rr1.0", {"TP_RR": 1.0}),
    ("rr1.5+slbuf0.3", {"TP_RR": 1.5, "SL_BUF_ATR": 0.3}),
]
