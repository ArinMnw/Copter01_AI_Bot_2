# -*- coding: utf-8 -*-
"""Cross-window falsification and optimization probes for S390."""
...
GROUPS = {
    "partial": (
        ("base", {}),
        ("partial010", {"PARTIAL_CORR_MIN": 0.10}),
        ("partial015", {"PARTIAL_CORR_MIN": 0.15}),
        ("partial025", {"PARTIAL_CORR_MIN": 0.25}),
        ("partial030", {"PARTIAL_CORR_MIN": 0.30}),
        ("rise005", {"PARTIAL_CORR_RISE_MIN": 0.05}),
        ("rise010", {"PARTIAL_CORR_RISE_MIN": 0.10}),
        ("rise020", {"PARTIAL_CORR_RISE_MIN": 0.20}),
        ("rise025", {"PARTIAL_CORR_RISE_MIN": 0.25}),
        ("raw000", {"LEAD_CORR_MIN": 0.00}),
...
def main():
    ...
    for name, cfg in GROUPS[args.group]:
        summary, _ = backtest(
            390, months, "M5", 0.20, 0.01, end, 300, cfg, prepared
        )
