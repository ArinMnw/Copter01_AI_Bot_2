...
def run(cfg):
    ...
    for i in range(LOOKBACK, len(all_bars) - 2):
        ...
        sig = strategy111.detect_s111(rates_slice, tf=TF, dt_bkk=dt_bkk, cfg=cfg)
...
V = {"MODE": "vwap"}
V = {"MODE_WEEKEND": False, "_cooldown": 30}
variants = [
    ("void3 (ref)", dict(V, VOID_MIN_ATR=3.0)),
    ("void3+tp0.5", dict(V, VOID_MIN_ATR=3.0, VOID_TP_PCT=0.5)),
    ("void3+tp0.75", dict(V, VOID_MIN_ATR=3.0, VOID_TP_PCT=0.75)),
    ("void2.5", dict(V, VOID_MIN_ATR=2.5)),
    ("void2.5+tp0.5", dict(V, VOID_MIN_ATR=2.5, VOID_TP_PCT=0.5)),
    ("void3+age50", dict(V, VOID_MIN_ATR=3.0, VOID_MAX_AGE=50)),
    ("void3+age200", dict(V, VOID_MIN_ATR=3.0, VOID_MAX_AGE=200)),
    ("void3+sl0.3", dict(V, VOID_MIN_ATR=3.0, VOID_SL_ATR=0.3)),
    ("void3+cd10", {"MODE_WEEKEND": False, "_cooldown": 10, "VOID_MIN_ATR": 3.0}),
]
