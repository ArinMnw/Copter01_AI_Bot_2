...
DEFAULT_FILES = [
    ...
    "strategy16.py",
    "strategy17.py",
    "tp_sl/strategy1_tp_sl.py",
    "tp_sl/strategy2_tp_sl.py",
    "handlers/keyboard.py",
    "handlers/callback_handler.py",
    "handlers/text_handler.py",
    "handlers/btn_auto.py",
    "handlers/btn_balance.py",
    "handlers/btn_buy.py",
    "handlers/btn_cancel_pending.py",
    "handlers/btn_close_all.py",
    "handlers/btn_order.py",
    "handlers/btn_pending.py",
    "handlers/btn_price.py",
    "handlers/btn_profit.py",
    "handlers/btn_scan_now.py",
    "handlers/btn_sell.py",
    "handlers/btn_settings.py",
    "handlers/btn_strategy.py",
    "handlers/btn_tf.py",
    "handlers/btn_tg_status.py",
]
