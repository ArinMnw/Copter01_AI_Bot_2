# -*- coding: utf-8 -*-
"""Fast exact payoff and breakeven sweep for S271."""
...
from strategy271 import detect_s271
from sweep_s235_payoff import _summary_market


RR_VALUES = (21.3, 21.4)
BE_VALUES = tuple(round(0.08 + 0.01 * index, 2) for index in range(18))
...
def main():
    ...
    for index in range(start_index, len(bars) - 1):
        ...
        signal = detect_s271(window, "M5", dt_bkk, base_cfg)
        validate_signal(signal, 271)
        cached[index] = signal
    rows = [
