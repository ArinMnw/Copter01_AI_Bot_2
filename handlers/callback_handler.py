...
_STRATEGY_DESC = {
    ...
    20.9: "🎯 *S20.9 Candle Action Reversal*\n\n"
          "เน้นการอ่านแรงแท่งเทียนที่เนื้อเทียนหนา\n"
          "1️⃣ *BUY*: แท่งแดง → แท่งเขียวปิดสูงกว่า open และ low สูงกว่า\n"
          "2️⃣ *SELL*: แท่งเขียว → แท่งแดงปิดต่ำกว่า open และ high ต่ำกว่า\n\n"
