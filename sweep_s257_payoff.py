# -*- coding: utf-8 -*-
"""Fast exact payoff and breakeven sweep for S257."""
...
from strategy257 import detect_s257
from sweep_s235_payoff import _summary_market


RR_VALUES = (30.0, 30.1, 30.2)
BE_VALUES = tuple(round(0.44 + 0.01 * index, 2) for index in range(32))
...
def main():
    ...
    for index in range(start_index, len(bars) - 1):
        ...
        signal = detect_s257(window, "M5", dt_bkk, base_cfg)
        validate_signal(signal, 257)
        cached[index] = signal
    rows = [
