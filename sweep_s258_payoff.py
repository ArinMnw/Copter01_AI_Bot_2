# -*- coding: utf-8 -*-
"""Fast exact payoff and breakeven sweep for S258."""
...
from strategy258 import detect_s258
...
def main():
    ...
    for index in range(start_index, len(bars) - 1):
        ...
        signal = detect_s258(window, "M5", dt_bkk, base_cfg)
        validate_signal(signal, 258)
        cached[index] = signal
    rows = [
