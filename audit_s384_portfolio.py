# -*- coding: utf-8 -*-
"""Parallel overlap, risk-distance, and portfolio audit for S384."""
...
def main():
    by_sid = {sid: [] for sid in (*BASE_IDS, 384)}
    h1_trades = {}
    risks = []
    ...
    target_times = {trade["signal_time"] for trade in h1_trades[384]}
    overlap = {
