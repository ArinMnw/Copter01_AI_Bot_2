...
raw = '''1. ATR 1D | 29-01-2026 13:00 | Sell 5590 | SL 5604 | TP 3058
2. ไม่มีท่า | 06-02-2026 07:00 | Buy 4658 | SL 4648 | TP 5407
...
12. Fibo 15M | 01-05-2026 21:00 | Sell 4656 | SL 4662 | TP 4506
...
30. ราคากินไส้ ไม่แน่ใจ TF | 07-07-2026 20:00 | Sell 4177 | SL 4180 | TP 3952
...
if start_idx != -1 and end_idx != -1:
    orig_lines = orig_lines[:start_idx] + [new_content] + orig_lines[end_idx:]
    with open('docs/allin4s/Full Trading/full_trading.md', 'w', encoding='utf-8') as f:
        f.writelines(orig_lines)
    print('Updated docs/allin4s/Full Trading/full_trading.md successfully.')
else:
