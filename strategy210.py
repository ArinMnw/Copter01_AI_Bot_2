# -*- coding: utf-8 -*-
"""S210 - Rollover opening-drive retest limit entry at the broken level, 10R."""
...
def detect_s210(rates, tf, dt_bkk, cfg):
    ...
    return {
        ...
        "tp": tp,
        "order_type": "limit",
        "pattern": f"S210 {signal} Rollover Drive Retest {rr:g}R",
