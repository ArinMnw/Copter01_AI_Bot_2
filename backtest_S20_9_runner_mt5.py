"""
sim_s20_9_backtest.py — Backtest S20.9 Candle Action
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
จำลองการรัน S20.9 โดยตรง:
...
def replay_tf(bars, tf_name, spread):
    ...
    for j in range(5, n - 1):
        ...
        res = strategy_20_9(rates_slice, tf=tf_name, dt_bkk=bar_dt_bkk)
        sig = res.get("signal")
        ...
        for m in range(j + 1, min(j + 1 + cancel_bars, n)):
            ...
            if sig == "BUY":
                ...
                # (แต่ตอนนี้ limit order ไม่ได้เช็ค pre-TP cancel) 
                # แต่เพื่อความเป๊ะ เราควรเช็ค
                if hi >= tp:
                    break
            else:
                if hi >= entry:
        ...
        trades.append({
            "tf": tf_name, 
            "signal": sig,
            "sub_pattern": res.get("pattern", "S20.9"),
            "outcome": outcome,
...
def main():
    ...
    # Export to CSV
    csv_file = "s20_9_backtest_summary.csv"
