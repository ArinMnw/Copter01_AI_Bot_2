# Strategy S20.204 Performance Summary

## Executive Overview
- **Strategy Name**: S20.204 — Deep Optimal Trade Entry (OTE 78.6%) Execution
- **Baseline Comparison**: Outperformed S20.203 (+$38,353.73) by **+$0.01**
...
การเข้าออเดอร์ที่จุดลึกที่สุดของ OTE (78.6% Retracement) เพื่อให้ได้ Risk ต่ำที่สุด
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.69** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.74** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.47R)
