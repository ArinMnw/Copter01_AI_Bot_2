# -*- coding: utf-8 -*-
"""strategy20_51.py
Strategy S20.51: Omni-Horizon Sovereign Apex Matrix + Fibonacci Premium/Discount Equilibrium Confluence & Quindeca-Stage Ratchet Trailing
...
6. Quindeca-Stage Quantum Ratchet Lock Engine (15 Stages):
   ...
   - Stage 15: Lock +6.30R @ +6.50R (Quindeca-Stage Ratchet Lock เพิ่มใหม่!)
   - Full Target: TP @ +6.75R (ขยายขอบเขตเป้าหมายกำไรสูงสุด)
...
def extract_setups(df, tf_label, min_vol=1.17, min_wick=0.32, retest_depth=0.124, sl_mult=0.20, hours=(0, 22),
                   use_pyh=True, use_ldn=True, use_ny=True, use_ny_pm=True, use_fvg=True, use_fibo=True):
    setups = []
    h_start, h_end = hours
