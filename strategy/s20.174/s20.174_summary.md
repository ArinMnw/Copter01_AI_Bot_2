# Strategy S20.174 Performance Summary

## Executive Overview
- **Strategy Name**: S20.174 — FVG Consequent Encroachment (50% CE) Defense
- **Baseline Comparison**: Outperformed S20.173 (+$38,340.48) by **+$0.07**
...
การตั้งรับที่จุดกึ่งกลาง 50% Consequent Encroachment ของ Fair Value Gap
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.74** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.55** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.60R)
