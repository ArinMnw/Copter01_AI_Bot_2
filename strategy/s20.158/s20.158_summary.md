# Strategy S20.158 Performance Summary

## Executive Overview
- **Strategy Name**: S20.158 — Institutional Session Killzone Ignition Filter
- **Baseline Comparison**: Outperformed S20.157 (+$38,339.69) by **+$0.02**
...
กรองช่วงเวลาทองคำที่มีสภาพคล่องสูงสุดของแต่ละ Session (London Open, NY Open, London Close)
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.90** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.71** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.44R)
