# Strategy S20.134 Performance Summary

## Executive Overview
- **Strategy Name**: S20.134 — Paradigm 4: Balanced Price Range BPR & Breakaway Void Confluence
- **Baseline Comparison**: Outperformed S20.133 (+$36,018.35) by **+$146.61**
...
| Metric | Value |
|---|---|
| **Total Trades Executed** | **4,212** |
| **Wins** | **3,618 (85.9%)** |
| **Breakevens** | **189 (4.5%)** |
| **Losses** | **405 (9.6%)** |
| **Non-Loss Rate** | **90.4%** |
| **Gross Profit** | **$37,172.32** |
| **Gross Loss** | **$1,007.36** |
| **Profit Factor** | **36.90** |
| **Net Profit** | **$36,164.96** |
| **Max Drawdown** | **$16.29** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (38 Stages, TP 11.55R)
