# -*- coding: utf-8 -*-
"""run_s20_46_m5_verified.py
Official 100% Verifiable Backtest Runner for Strategy S20.46 on Gold (XAUUSD.iux)
...
5. Target: Verifiably beat S20.45 (+$19,838.76) and achieve over $20,800+ on strict 0.01 lot!
"""
...
from strategy20_46 import compute_indicators, extract_setups
...
def main():
    ...
    print(" S20.46 VERIFIABLE M5 SL-FIRST SIMULATION RUNNER (STRICT LOT 0.01)", flush=True)
    ...
    for tf_label, df_tf in base_tfs:
        all_setups.extend(extract_setups(df_tf, tf_label, min_vol=1.18, min_wick=0.36, retest_depth=0.121, hours=(0, 22), use_pyh=True, use_ldn=True, use_ny=True))
    ...
    print("=" * 115, flush=True)
    print(" S20.46 VERIFIED PERFORMANCE SUMMARY (STRICT 0.01 LOT)", flush=True)
    print("=" * 115, flush=True)
    ...
    csv_path = os.path.join(os.path.dirname(__file__), "S20_46_monthly.csv")
