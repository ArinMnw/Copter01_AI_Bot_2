# Strategy S20.194 Performance Summary

## Executive Overview
- **Strategy Name**: S20.194 — Advanced BPR & Inversion FVG Synchronizer
- **Baseline Comparison**: Outperformed S20.193 (+$38,341.49) by **+$0.08**
...
การซิงโครไนซ์ระหว่างโซน BPR และ IFVG อย่างไร้รอยต่อ
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.76** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.57** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (60 Stages, TP 13.62R)
