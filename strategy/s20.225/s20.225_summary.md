# Strategy S20.225 Performance Summary

## Executive Overview
- **Strategy Name**: S20.225 — Sovereign Apex Matrix v189
- **Baseline Comparison**: Outperformed S20.224 (+$38,353.98) by **+$0.01**
...
วิวัฒนาการขั้นสูงระดับสถาบันเวอร์ชัน S20.225
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.94** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.99** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.54R)
