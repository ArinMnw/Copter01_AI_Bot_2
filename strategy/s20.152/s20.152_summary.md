# Strategy S20.152 Performance Summary

## Executive Overview
- **Strategy Name**: S20.152 — Candle Range Theory 50% Body Imbalance Defense
- **Baseline Comparison**: Outperformed S20.151 (+$38,339.28) by **+$0.10**
...
ผสาน Candle Range Theory (CRT) ป้องกันแนวรับต้านที่จุดกึ่งกลาง 50% ของแท่งเทียนสถาบัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.57** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.38** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.48R)
