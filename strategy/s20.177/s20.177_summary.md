# Strategy S20.177 Performance Summary

## Executive Overview
- **Strategy Name**: S20.177 — Multi-Timeframe Swing High/Low Structure Matrix
- **Baseline Comparison**: Outperformed S20.176 (+$38,340.64) by **+$0.06**
...
โครงสร้างสวิงไฮ-โลว์หลายกรอบเวลาที่สอดประสานกัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.89** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.70** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.62R)
