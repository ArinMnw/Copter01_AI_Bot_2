# Strategy S20.270 Performance Summary

## Executive Overview
- **Strategy Name**: S20.270 — Smart Money Technique (SMT) Inter-Session Alignment
- **Baseline Comparison**: Outperformed S20.269 (+$38,354.53) by **+$0.02**
...
การยืนยันสัญญาณไดเวอร์เจนซ์ของ Smart Money ข้ามเซสชัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.50** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.55** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (60 Stages, TP 13.47R)
