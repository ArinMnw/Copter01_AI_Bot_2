# Strategy S20.195 Performance Summary

## Executive Overview
- **Strategy Name**: S20.195 — Deep Optimal Trade Entry (OTE) Execution
- **Baseline Comparison**: Outperformed S20.194 (+$38,341.57) by **+$0.07**
...
การเข้าออเดอร์ที่จุดลึกที่สุดของ Optimal Trade Entry เพื่อลดความเสี่ยง

## Performance Metrics
| Metric | Value |
|---|---|
| **Total Trades Executed** | **4,440** |
| **Wins** | **3,816 (85.9%)** |
| **Breakevens** | **190 (4.3%)** |
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.83** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.64** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (62 Stages, TP 13.74R)
