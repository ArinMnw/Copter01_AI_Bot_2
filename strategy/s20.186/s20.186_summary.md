# Strategy S20.186 Performance Summary

## Executive Overview
- **Strategy Name**: S20.186 — Multi-Bar Liquidity Pool Depletion
- **Baseline Comparison**: Outperformed S20.185 (+$38,341.03) by **+$0.04**
...
การตรวจจับการแห้งเหือดของสภาพคล่องในบาร์ถัดไปเพื่อยืนยันจุดกลับตัว
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.26** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.07** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.64R)
