# Strategy S20.188 Performance Summary

## Executive Overview
- **Strategy Name**: S20.188 — Adaptive Volatility-Scaled Stop Loss Buffer
- **Baseline Comparison**: Outperformed S20.187 (+$38,341.13) by **+$0.08**
...
การปรับระยะบัฟเฟอร์ Stop Loss ตามค่า ATR แบบเรียลไทม์
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.40** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.21** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.63R)
