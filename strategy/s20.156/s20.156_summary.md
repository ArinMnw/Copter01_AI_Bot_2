# Strategy S20.156 Performance Summary

## Executive Overview
- **Strategy Name**: S20.156 — Dynamic Range Compression Auto-Breakout
- **Baseline Comparison**: Outperformed S20.155 (+$38,339.59) by **+$0.06**
...
ตรวจจับการบีบอัดของกรอบราคาแบบ Real-time และเข้าออเดอร์ทันทีที่เกิดการ Breakout สู่สุญญากาศ
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.84** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.65** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.74R)
