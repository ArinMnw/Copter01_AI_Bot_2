# Strategy S20.143 Performance Summary

## Executive Overview
- **Strategy Name**: S20.143 — Optimal Trade Entry (OTE 70.5%) Confluence
- **Baseline Comparison**: Outperformed S20.142 (+$38,338.23) by **+$0.01**
...
ผสานระดับสัดส่วนการกลับตัวสถาบัน Optimal Trade Entry (OTE 70.5% / 78.6%) ร่วมกับการ Sweep สภาพคล่อง
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,388.43** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,338.24** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.70R)
