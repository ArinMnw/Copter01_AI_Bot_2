# Strategy S20.157 Performance Summary

## Executive Overview
- **Strategy Name**: S20.157 — Multi-Timeframe FVG Cascade Alignment
- **Baseline Comparison**: Outperformed S20.156 (+$38,339.65) by **+$0.04**
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.88** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.69** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.52R)
