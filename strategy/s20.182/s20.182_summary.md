# Strategy S20.182 Performance Summary

## Executive Overview
- **Strategy Name**: S20.182 — Breaker Block & FVG Dual-Engine Fusion
- **Baseline Comparison**: Outperformed S20.181 (+$38,340.87) by **+$0.04**
...
การประกบคู่ระหว่าง Breaker Block และ FVG เพื่อสร้างโซนซ้อนทับพลังงานสูง
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.10** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.91** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.62R)
