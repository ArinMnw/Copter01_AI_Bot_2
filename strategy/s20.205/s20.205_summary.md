# Strategy S20.205 Performance Summary

## Executive Overview
- **Strategy Name**: S20.205 — Midnight Open (00:00 UTC) Accumulation Deviation
- **Baseline Comparison**: Outperformed S20.204 (+$38,353.74) by **+$0.01**
...
วัดการสะสมของราคาจากเส้นราคาเปิดแท้จริง Midnight Open เพื่อจับรอบคลื่นประจำวัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.70** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.75** |
| **Max Drawdown** | **$16.63** |
