# Strategy S20.147 Performance Summary

## Executive Overview
- **Strategy Name**: S20.147 — Volume Profile POC Migration & Value Area Rejection
- **Baseline Comparison**: Outperformed S20.146 (+$38,338.66) by **+$0.29**
...
คำนวณการเคลื่อนย้ายของ Point of Control (POC) เพื่อดักจับการปฏิเสธราคาที่ขอบ Value Area
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.14** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,338.95** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.72R)
