# Strategy S20.164 Performance Summary

## Executive Overview
- **Strategy Name**: S20.164 — Inversion Breaker Block Dynamic Support
- **Baseline Comparison**: Outperformed S20.163 (+$38,339.97) by **+$0.06**
...
การกลับขั้วของ Breaker Block จากแนวรับกลายเป็นแนวต้านและแนวต้านกลายเป็นแนวรับ
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.22** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.03** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.48R)
