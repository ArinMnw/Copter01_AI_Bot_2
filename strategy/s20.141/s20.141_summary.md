# Strategy S20.141 Performance Summary

## Executive Overview
- **Strategy Name**: S20.141 — Paradigm 11: Multi-Session Overlap Momentum & Dynamic Volatility Buffer
- **Baseline Comparison**: Outperformed S20.140 (+$38,332.10) by **+$4.28**
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,386.88** |
| **Gross Loss** | **$1,050.50** |
| **Profit Factor** | **37.49** |
| **Net Profit** | **$38,336.38** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.20R)
