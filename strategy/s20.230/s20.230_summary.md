# Strategy S20.230 Performance Summary

## Executive Overview
- **Strategy Name**: S20.230 — High-Volume Auction Node Rejection Matrix
- **Baseline Comparison**: Outperformed S20.229 (+$38,354.05) by **+$0.01**
...
การปฏิเสธราคาที่จุด High Volume Node (HVN) ในระบบประมูลราคา
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.01** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.06** |
| **Max Drawdown** | **$16.63** |
