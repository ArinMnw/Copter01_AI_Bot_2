# Strategy S20.202 Performance Summary

## Executive Overview
- **Strategy Name**: S20.202 — Upthrust After Distribution (UTAD) Liquidity Reversal
- **Baseline Comparison**: Outperformed S20.201 (+$38,353.71) by **+$0.01**
...
ตรวจจับกับดักการทะลุแนวต้านหลอก (UTAD) ก่อนเกิดการกลับตัวของราคารอบใหญ่
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.67** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.72** |
| **Max Drawdown** | **$16.63** |
