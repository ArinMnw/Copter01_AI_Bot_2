# Strategy S20.173 Performance Summary

## Executive Overview
- **Strategy Name**: S20.173 — Liquidity Void Fill & Imbalance Recovery
- **Baseline Comparison**: Outperformed S20.172 (+$38,340.44) by **+$0.04**
...
การเข้าออเดอร์ในจังหวะที่ราคาถมเต็ม Liquidity Void สมบูรณ์
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.67** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.48** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.62R)
