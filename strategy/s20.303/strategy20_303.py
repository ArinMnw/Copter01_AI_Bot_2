...
Core Innovations:
1. แนวทางที่ 3: ระบบปรับจูนเป้ากำไรและระยะ Trailing อัตโนมัติตามสภาวะความผันผวนของทองคำ (56 Stages, TP 13.45R)
...
4. Multi-Stage Quantum Ratchet Lock Engine (56 Stages, TP 13.45R)
5. Parameter Delta: Depth Offset +0.0000, SL Mult Offset +0.0030
"""

CONFIG = {
    "version": "S20.303",
    "name": "Dynamic Volatility-Scaled Adaptive Engine",
