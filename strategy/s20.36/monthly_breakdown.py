# -*- coding: utf-8 -*-
"""monthly_breakdown.py — Generate detailed monthly tear sheet for S20.36 Champion.
...
def main():
    ...
    csv_path = os.path.join(current_dir, "S20_36_monthly.csv")
    
    monthly_stats = []
    print("\n" + "=" * 95)
    print(" S20.36 OMNI-HORIZON QUANTUM SOVEREIGN — 365-DAY MONTHLY TEAR SHEET")
