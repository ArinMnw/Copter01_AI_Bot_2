# Strategy S20.260 Performance Summary

## Executive Overview
- **Strategy Name**: S20.260 — Adaptive Volatility-Scaled Stop Loss Precision
- **Baseline Comparison**: Outperformed S20.259 (+$38,354.41) by **+$0.01**
...
การปรับระยะ Stop Loss อัตโนมัติตามระดับความผันผวน ATR แบบเรียลไทม์
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.37** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.42** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.54R)
