# Strategy S20.210 Performance Summary

## Executive Overview
- **Strategy Name**: S20.210 — Institutional Mitigation Block Order Flow Defense
- **Baseline Comparison**: Outperformed S20.209 (+$38,353.80) by **+$0.01**
...
ดักจับการกลับมาปิดสถานะขาดทุนของสถาบันที่ Mitigation Block
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.76** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.81** |
| **Max Drawdown** | **$16.63** |
