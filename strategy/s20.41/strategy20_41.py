# -*- coding: utf-8 -*-
"""strategy20_41.py
Strategy S20.41: Omni-Horizon Sovereign Apex Matrix (H4-H3-H2-H1-M30-M15 & 52-Week Macro Liquidity)
Core Innovations:
...
2. Omni-Horizon Timeframe Matrix: H4 + H3 + H2 + H1 + M30 + M15 (Complete institutional horizon coverage)
3. Sovereign Session Window: 02:00 to 22:00 UTC (09:00 to 05:00 BKK - capturing Tokyo/Asian morning drive to NY close before rollover)
...
def extract_setups(df, tf_label, min_vol=1.20, min_wick=0.38, retest_depth=0.130, sl_mult=0.20, hours=(2, 22), use_pyh=True):
    setups = []
    h_start, h_end = hours
