# -*- coding: utf-8 -*-
"""run_s20_64_m5_verified.py
Official 100% Verifiable Backtest Runner for Strategy S20.64 on Gold (XAUUSD.iux)
"""
...
def main():
    ...
    print(" S20.64 VERIFIABLE M5 SL-FIRST SIMULATION RUNNER (STRICT LOT 0.01)", flush=True)
    ...
    base_dfs = [(tf, compute_indicators(r, True, True, True, fvg_depth=7)) for tf, r in rates.items()]
    ...
    print("=" * 115, flush=True)
    print(" S20.64 VERIFIED PERFORMANCE SUMMARY (STRICT 0.01 LOT)", flush=True)
    print("=" * 115, flush=True)
    ...
    csv_path = os.path.join(os.path.dirname(__file__), "S20_64_monthly.csv")
