# Strategy S20.256 Performance Summary

## Executive Overview
- **Strategy Name**: S20.256 — Sovereign Apex Matrix v220
- **Baseline Comparison**: Outperformed S20.255 (+$38,354.36) by **+$0.02**
...
วิวัฒนาการขั้นสูงระดับสถาบันเวอร์ชัน S20.256
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.33** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.38** |
| **Max Drawdown** | **$16.63** |
