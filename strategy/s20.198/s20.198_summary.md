# Strategy S20.198 Performance Summary

## Executive Overview
- **Strategy Name**: S20.198 — High-Precision Retest Limit Entry Protocol
- **Baseline Comparison**: Outperformed S20.197 (+$38,341.80) by **+$0.17**
...
โปรโตคอลการตั้ง Limit Retest ที่มีความแม่นยำสูงระดับจุดทศนิยม
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,392.16** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.97** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (60 Stages, TP 13.67R)
