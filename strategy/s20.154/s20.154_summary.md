# Strategy S20.154 Performance Summary

## Executive Overview
- **Strategy Name**: S20.154 — Asian Session True Range Expansion Acceleration
- **Baseline Comparison**: Outperformed S20.153 (+$38,339.46) by **+$0.08**
...
คำนวณการระเบิดกรอบราคาออกจากกรอบ Asian Range ด้วยแรงส่งระดับสูง
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.73** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.54** |
| **Max Drawdown** | **$16.63** |
