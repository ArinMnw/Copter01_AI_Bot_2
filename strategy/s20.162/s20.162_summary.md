# Strategy S20.162 Performance Summary

## Executive Overview
- **Strategy Name**: S20.162 — Wyckoff Spring & Upthrust After Distribution (UTAD)
- **Baseline Comparison**: Outperformed S20.161 (+$38,339.86) by **+$0.05**
...
ผสานแพทเทิร์น Spring และ UTAD ตามหลักการ Wyckoff VSA ขั้นสูง
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.10** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.91** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.52R)
