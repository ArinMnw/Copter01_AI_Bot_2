# Strategy S20.220 Performance Summary

## Executive Overview
- **Strategy Name**: S20.220 — Candle Range Theory 50% Body Imbalance Reversal
- **Baseline Comparison**: Outperformed S20.219 (+$38,353.92) by **+$0.01**
...
การเข้าเทรดที่จุดกึ่งกลาง 50% Body ของแท่งเทียน Imbalance สถาบัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.88** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.93** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.45R)
