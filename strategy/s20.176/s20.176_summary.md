# Strategy S20.176 Performance Summary

## Executive Overview
- **Strategy Name**: S20.176 — Session Equilibrium True Open Oscillator
- **Baseline Comparison**: Outperformed S20.175 (+$38,340.60) by **+$0.04**
...
การวัดระยะห่างของราคาจากจุดสมดุลของรอบ Session
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.83** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.64** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.64R)
