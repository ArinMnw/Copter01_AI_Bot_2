# Strategy S20.155 Performance Summary

## Executive Overview
- **Strategy Name**: S20.155 — Institutional Mitigation Block Order Flow
- **Baseline Comparison**: Outperformed S20.154 (+$38,339.54) by **+$0.05**
...
ดักจับการกลับมาปิดสถานะของสถาบันที่ Mitigation Block ก่อนเริ่มเทรนด์ใหญ่
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.78** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.59** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.73R)
