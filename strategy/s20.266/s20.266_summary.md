# Strategy S20.266 Performance Summary

## Executive Overview
- **Strategy Name**: S20.266 — Sovereign Apex Matrix v230
- **Baseline Comparison**: Outperformed S20.265 (+$38,354.48) by **+$0.02**
...
วิวัฒนาการขั้นสูงระดับสถาบันเวอร์ชัน S20.266
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.45** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.50** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (60 Stages, TP 13.46R)
