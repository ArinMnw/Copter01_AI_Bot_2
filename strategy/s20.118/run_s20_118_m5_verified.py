# -*- coding: utf-8 -*-
"""run_s20_118_m5_verified.py
Official 100% Verifiable Backtest Runner for Strategy S20.118 on Gold (XAUUSD.iux)
"""
...
def main():
    ...
    print(" S20.118 VERIFIABLE M5 SL-FIRST SIMULATION RUNNER (STRICT LOT 0.01)", flush=True)
    ...
    print("=" * 115, flush=True)
    print(" S20.118 VERIFIED PERFORMANCE SUMMARY (STRICT 0.01 LOT)", flush=True)
    print("=" * 115, flush=True)
    ...
    csv_path = os.path.join(os.path.dirname(__file__), "S20_118_monthly.csv")
