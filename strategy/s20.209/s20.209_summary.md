# Strategy S20.209 Performance Summary

## Executive Overview
- **Strategy Name**: S20.209 — Multi-Timeframe FVG Cascade Alignment (H4+H1+M15)
- **Baseline Comparison**: Outperformed S20.208 (+$38,353.79) by **+$0.01**
...
การเรียงตัวของ Fair Value Gap พร้อมกันทั้งระดับ H4, H1 และ M15
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.75** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.80** |
| **Max Drawdown** | **$16.63** |
