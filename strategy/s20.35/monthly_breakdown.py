# -*- coding: utf-8 -*-
"""monthly_breakdown.py — Generate detailed monthly tear sheet for S20.35 Champion.
...
def main():
    ...
    csv_path = os.path.join(current_dir, "S20_35_monthly.csv")
    
    monthly_stats = []
    print("\n" + "=" * 95)
    print(" S20.35 OMNI-HORIZON INSTITUTIONAL NEXUS — 365-DAY MONTHLY TEAR SHEET")
