# -*- coding: utf-8 -*-
"""strategy20_35.py — S20.35 Omni-Horizon Institutional Nexus Matrix:
...
5. Precision Retest Entry (20.0% Retest Depth of the Wick, SL behind wick tip)
6. Extended Global Session Window (London Pre-Open through NY Close: 07:00 - 21:00 server time)
7. Quad-Horizon Coverage (H4 Macro + H1 Trend + M30 Structural + M15 Intraday, with 15-min dedup)
8. Tri-Stage Ratchet Lock Engine:
...
def evaluate_setup(cur, tf_label="M30", min_vol=1.30, min_wick=0.38, retest_depth=0.200, hours=(7, 21)):
