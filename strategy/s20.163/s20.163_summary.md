# Strategy S20.163 Performance Summary

## Executive Overview
- **Strategy Name**: S20.163 — Balanced Price Range Re-test & Gap Acceleration
- **Baseline Comparison**: Outperformed S20.162 (+$38,339.91) by **+$0.06**
...
การย้ำทดสอบโซน BPR เพื่อดึงอัตราเร่งของราคา
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.16** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.97** |
| **Max Drawdown** | **$16.63** |
