# Strategy S20.290 Performance Summary

## Executive Overview
- **Strategy Name**: S20.290 — Extended Quantum Ratchet Velocity Trailing Engine
- **Baseline Comparison**: Outperformed S20.289 (+$38,354.82) by **+$0.02**
...
ระบบปรับสปีดการล็อกกำไรตามความเร็วของคลื่นกระชากราคา
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.79** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.84** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (60 Stages, TP 13.50R)
