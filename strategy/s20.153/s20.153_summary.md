# Strategy S20.153 Performance Summary

## Executive Overview
- **Strategy Name**: S20.153 — Market Structure Shift (MSS) Displacement Confirmation
- **Baseline Comparison**: Outperformed S20.152 (+$38,339.38) by **+$0.08**
...
ยืนยันการเปลี่ยนโครงสร้างราคาด้วยแท่งเทียน Displacement พลังงานสูง (Body >= 65%)
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.65** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.46** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.49R)
