# -*- coding: utf-8 -*-
"""run_s20_88_m5_verified.py
Official 100% Verifiable Backtest Runner for Strategy S20.88 on Gold (XAUUSD.iux)
"""
...
def main():
    ...
    print(" S20.88 VERIFIABLE M5 SL-FIRST SIMULATION RUNNER (STRICT LOT 0.01)", flush=True)
    ...
    res = run_simulation(m5_gold, m5_times, combined, tp_r=7.77, stages=stages)

    print("=" * 115, flush=True)
    print(" S20.88 VERIFIED PERFORMANCE SUMMARY (STRICT 0.01 LOT)", flush=True)
    print("=" * 115, flush=True)
    ...
    csv_path = os.path.join(os.path.dirname(__file__), "S20_88_monthly.csv")
