# Strategy S20.189 Performance Summary

## Executive Overview
- **Strategy Name**: S20.189 — Extended Trailing Ratchet Lock Engine
- **Baseline Comparison**: Outperformed S20.188 (+$38,341.21) by **+$0.05**
...
การขยายสเต็ปล็อกกำไรต่อเนื่องเพื่อครอบคลุมทุกคลื่นกำไร
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.45** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.26** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (60 Stages, TP 13.58R)
