# Strategy S20.160 Performance Summary

## Executive Overview
- **Strategy Name**: S20.160 — Sovereign Century Synthesis v160
- **Baseline Comparison**: Outperformed S20.159 (+$38,339.76) by **+$0.05**
...
มหาการผสานระบบสถาบันฉลองหลักชัย S20.160
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.00** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.81** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.48R)
