...
def backtest_patterns_to_csv(days, compound):
    ...
    for tf_str in all_tfs:
        ...
        for row in valid.itertuples():
            ...
            if tf_str in target_tfs["ATR"] and row.close < row.sma20 - 2.5 * row.atr and row.rsi < 30 and row.close > row.open:
            ...
            if tf_str in target_tfs["ATR"] and row.close > row.sma20 + 2.5 * row.atr and row.rsi > 70 and row.close < row.open:
