...
if __name__ == '__main__':
    ...
    target_tfs = {"Naiya": [], "Inst_Gap": [], "Fibo": ["H1"], "FVG": ["H1"], "GapSweep": [], "Doji": [], "MA12": [], "Div": ["H1"], "ATR": ["H1"]}
    ...
    def get_dynamic_tp(current_time, is_buy, tf_str, pattern_list):
        ...
        if target_tf == 'D1': days = 365
        elif target_tf == 'H12': days = 365
        elif target_tf == 'H4': days = 365
        elif target_tf == 'H1': days = 365
        elif target_tf == 'M30': days = 365
        else: days = 365
