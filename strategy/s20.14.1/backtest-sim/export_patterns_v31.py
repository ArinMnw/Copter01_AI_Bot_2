    ...
    for tf_str in all_tfs:
        ...
        for row in valid.itertuples():
            ...
            if patterns_buy:
                ...
                # 🎯 Sniper Limit Order: ดักรอที่ใกล้ Swing Low (Swing Low + 0.5 ATR)
                limit_price = row.recent_low + (row.atr * 0.5)
            ...
            if patterns_sell:
                ...
                # 🎯 Sniper Limit Order: ดักรอที่ใกล้ Swing High (Swing High - 0.5 ATR)
                limit_price = row.recent_high - (row.atr * 0.5)
