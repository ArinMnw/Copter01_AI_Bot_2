            ...
            if tf_str == 'H1' and tf_str in target_tfs.get("Naiya", []):
                ...
                if len(valid) >= 40:
                    ...
                    if naiya_found:
                        ...
                        if row['high'] > valid.iloc[-2]['high'] and row['close'] < row['high']:
                            g12o15_sell = True
                            g12o15_entry = naiya_doji_high
                            g12o15_sl = naiya_high
                            
                            # TP: Lowest low since Naiya
                            g12o15_tp = valid.iloc[-300:]['low'].min()

            if g12o15_sell:
                    print(f'Triggered at {row.time_dt} with Entry {g12o15_entry}')
