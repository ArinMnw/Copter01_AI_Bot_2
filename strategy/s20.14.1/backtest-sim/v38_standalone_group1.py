...
if __name__ == '__main__':
    ...
    compound = 0.01
    group_id = 1
    target_orders = [1, 5, 10, 14, 17, 19, 23, 25, 28, 32, 33, 35, 36]
    target_tfs = {'Naiya': ['M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'H12', 'D1'], 'Inst_Gap': ['M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'H12', 'D1'], 'Fibo': ['M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'H12', 'D1'], 'FVG': ['M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'H12', 'D1'], 'GapSweep': ['M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'H12', 'D1'], 'Doji': ['M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'H12', 'D1'], 'MA12': ['M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'H12', 'D1'], 'Div': ['M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'H12', 'D1'], 'ATR': ['M1', 'M5', 'M15', 'M30', 'H1', 'H4', 'H12', 'D1']}
