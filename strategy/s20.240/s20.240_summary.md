# Strategy S20.240 Performance Summary

## Executive Overview
- **Strategy Name**: S20.240 — Session Liquidity Injection Macro Acceleration
- **Baseline Comparison**: Outperformed S20.239 (+$38,354.17) by **+$0.01**
...
การเร่งแรงส่งของราคาตามหน้าต่างเวลา Macro 20 นาทีของอัลกอริทึมสถาบัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.13** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.18** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.50R)
