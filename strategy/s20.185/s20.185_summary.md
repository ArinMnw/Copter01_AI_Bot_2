# Strategy S20.185 Performance Summary

## Executive Overview
- **Strategy Name**: S20.185 — True Range Velocity Guard
- **Baseline Comparison**: Outperformed S20.184 (+$38,340.99) by **+$0.04**
...
ระบบป้องกันการเข้าออเดอร์ในจังหวะที่ความเร็วแท่งเทียนผิดปกติ
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.22** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.03** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.69R)
