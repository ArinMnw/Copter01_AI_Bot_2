# Strategy S20.192 Performance Summary

## Executive Overview
- **Strategy Name**: S20.192 — Multi-Timeframe Equilibrium Re-balancing Protocol
- **Baseline Comparison**: Outperformed S20.191 (+$38,341.39) by **+$0.06**
...
การกลับสู่จุดสมดุลของหลายกรอบเวลาพร้อมกัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.64** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.45** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.66R)
