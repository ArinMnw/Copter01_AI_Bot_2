# Strategy S20.167 Performance Summary

## Executive Overview
- **Strategy Name**: S20.167 — Weekly Profile Template Low/High of Week Formation
- **Baseline Comparison**: Outperformed S20.166 (+$38,340.14) by **+$0.05**
...
การดักจับจุดต่ำสุดหรือสูงสุดของสัปดาห์ (Low/High of the Week)
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.38** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.19** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.50R)
