# -*- coding: utf-8 -*-
"""strategy20_50.py
Strategy S20.50: Omni-Horizon Sovereign Apex Matrix + Multi-Session Liquidity Pools & Quattuordeca-Stage Ratchet Trailing
Core Innovations:
...
6. Quattuordeca-Stage Quantum Ratchet Lock Engine (14 Stages):
   ...
   - Stage 14: Lock +6.15R @ +6.35R (Quattuordeca-Stage Lock เพิ่มใหม่!)
   - Full Target: TP @ +6.65R (ขยายขอบเขตเป้าหมายกำไรสูงสุด)
...
def extract_setups(df, tf_label, min_vol=1.17, min_wick=0.33, retest_depth=0.124, sl_mult=0.20, hours=(0, 22), use_pyh=True, use_ldn=True, use_ny=True, use_ny_pm=True, use_fvg=True):
    setups = []
    h_start, h_end = hours
