# Strategy S20.191 Performance Summary

## Executive Overview
- **Strategy Name**: S20.191 — Institutional Order Flow Acceleration Matrix
- **Baseline Comparison**: Outperformed S20.190 (+$38,341.31) by **+$0.08**
...
การเร่งแรงส่งตามกระแสเงินทุนสถาบัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.58** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.39** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.68R)
