# -*- coding: utf-8 -*-
"""strategy20_84.py
Strategy S20.84: Omni-Horizon Sovereign Apex Matrix + Multi-Strategy Single-Candle Confluence & Trailing Ratchet
...
1. Multi-Strategy Single-Candle Cross-Breed Confluence (Working together on the EXACT SAME BAR):
   ...
   - Multi-Bar Fair Value Gap Memory (Strategy 1 & 2): โซนความไม่สมดุลของสภาพคล่อง FVG แบบ Multi-Bar Memory (ย้อนหลัง 6 แท่งเทียน)
   ...
   - Price Action Rejection Wick: lower_wick_pct / upper_wick_pct >= 15.0% or wick >= 1.1x body
