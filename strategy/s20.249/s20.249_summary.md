# Strategy S20.249 Performance Summary

## Executive Overview
- **Strategy Name**: S20.249 — Sovereign Apex Matrix v213
- **Baseline Comparison**: Outperformed S20.248 (+$38,354.28) by **+$0.01**
...
วิวัฒนาการขั้นสูงระดับสถาบันเวอร์ชัน S20.249
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.24** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.29** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.49R)
