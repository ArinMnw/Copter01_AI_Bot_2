# Strategy S20.196 Performance Summary

## Executive Overview
- **Strategy Name**: S20.196 — Wyckoff Volume Effort vs Result Master Confirmation
- **Baseline Comparison**: Outperformed S20.195 (+$38,341.64) by **+$0.05**
...
การยืนยันความพยายามเทียบกับผลลัพธ์ของ Volume ขั้นสูง
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.88** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.69** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (62 Stages, TP 13.75R)
