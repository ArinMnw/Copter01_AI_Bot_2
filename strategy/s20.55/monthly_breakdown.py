...
Display formatted monthly tear sheet for S20.55 from S20_55_monthly.csv.
"""
import pandas as pd
import os, sys
...
if not os.path.exists(csv_path):
    print("CSV not found. Run run_s20_55_m5_verified.py first.")
    sys.exit(1)

df = pd.read_csv(csv_path)
print("=" * 85)
print(" STRATEGY S20.55: OFFICIAL VERIFIED MONTHLY TEAR SHEET (STRICT 0.01 LOT)")
print("=" * 85)
