# Strategy S20.183 Performance Summary

## Executive Overview
- **Strategy Name**: S20.183 — Volume Profile Developing Value Area (dVA) Dynamic Shift
- **Baseline Comparison**: Outperformed S20.182 (+$38,340.91) by **+$0.05**
...
การขยับตัวของ Value Area แบบไดนามิกตามการประมูลราคาในรอบวัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.15** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.96** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.68R)
