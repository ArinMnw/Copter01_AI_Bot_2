...
Display and export detailed monthly performance for Strategy S20.44 on Gold (XAUUSD.iux).
"""
...
def display_monthly():
    ...
    if not os.path.exists(csv_path):
        print(f"Error: {csv_path} not found. Please run run_s20_44_m5_verified.py first.")
        return

    df = pd.read_csv(csv_path)
    print("=" * 75)
    print(" STRATEGY S20.44: OFFICIAL MONTHLY PERFORMANCE BREAKDOWN (0.01 LOT)")
    print("=" * 75)
