# Strategy S20.145 Performance Summary

## Executive Overview
- **Strategy Name**: S20.145 — Midnight Open (00:00 UTC) True Day Deviation
- **Baseline Comparison**: Outperformed S20.144 (+$38,338.35) by **+$0.15**
...
คำนวณการเบี่ยงเบนของราคาจากราคาเปิดแท้จริง Midnight Open เพื่อดักจับการสะสมของสถาบัน (Accumulation)
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,388.69** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,338.50** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.75R)
