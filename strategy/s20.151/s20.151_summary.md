# Strategy S20.151 Performance Summary

## Executive Overview
- **Strategy Name**: S20.151 — Turtle Soup Liquidity Pool False-Breakout Trap
- **Baseline Comparison**: Outperformed S20.150 (+$38,339.25) by **+$0.03**
...
เทคนิค Turtle Soup กวาดกินสภาพคล่องเหนือ/ใต้กรอบ Session ก่อนดึงราคากลับอย่างรุนแรง
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.47** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.28** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.44R)
