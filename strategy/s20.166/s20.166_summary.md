# Strategy S20.166 Performance Summary

## Executive Overview
- **Strategy Name**: S20.166 — Institutional Absorption Climax at Extremes
- **Baseline Comparison**: Outperformed S20.165 (+$38,340.09) by **+$0.05**
...
การดูดซับแรงขาย/ซื้อที่จุดสูงสุดและต่ำสุดของรอบวัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.33** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.14** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.55R)
