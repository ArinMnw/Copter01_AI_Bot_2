# Strategy S20.184 Performance Summary

## Executive Overview
- **Strategy Name**: S20.184 — London-NY Overlap Climax Reversal
- **Baseline Comparison**: Outperformed S20.183 (+$38,340.96) by **+$0.03**
...
การจับจุดจบรอบการกระชากของช่วงเวลา London-NY Overlap
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.18** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.99** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.63R)
