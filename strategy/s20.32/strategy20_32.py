# -*- coding: utf-8 -*-
"""strategy20_32.py — S20.32 Dual-Horizon Institutional Synergy Matrix:
...
5. Sniper Retest Entry (Fibo 38.2% of Wick, SL behind wick tip)
6. Dual-Horizon Coverage (M15 Intraday + M30 Structural, with 15-min dedup)
7. Dual-Stage Profit Lock (BE at +0.8R, Lock +1.0R at +1.6R, Target 2.5R)
...
def evaluate_setup(df, idx, tf_label="M30", min_vol=1.30, min_wick=0.38):
    ...
    # Fibo 38.2% Retest Entry & Tight SL behind wick
