# Strategy S20.208 Performance Summary

## Executive Overview
- **Strategy Name**: S20.208 — Turtle Soup Session Range Expansion Trap
- **Baseline Comparison**: Outperformed S20.207 (+$38,353.78) by **+$0.01**
...
เทคนิค Turtle Soup ดักจับการหลุดกรอบเซสชันลวงเพื่อสวนกลับทิศทางหลัก
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.74** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.79** |
| **Max Drawdown** | **$16.63** |
