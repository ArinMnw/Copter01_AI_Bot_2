# -*- coding: utf-8 -*-
"""strategy20_34.py — S20.34 Apex Institutional Quantum Matrix:
...
5. Precision Retest Entry (25.0% Retest Depth of the Wick, SL behind wick tip)
6. Extended Active Session (London Open through NY Afternoon: 08:00 - 20:00 server time)
7. Triple-Horizon Coverage (H1 Macro + M30 Structural + M15 Intraday, with 15-min dedup)
...
def evaluate_setup(cur, tf_label="M30", min_vol=1.30, min_wick=0.38, retest_depth=0.250, hours=(8, 20)):
