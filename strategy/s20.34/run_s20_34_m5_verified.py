# -*- coding: utf-8 -*-
"""run_s20_34_m5_verified.py — 100% Verifiable M5 Sequential Execution:
...
5. Tri-Stage Ratchet Profit Lock: BE at +0.8R, Lock +1.0R at +1.5R, Lock +1.8R at +2.2R, Target 2.6R.
"""
...
def main():
    ...
    print("=" * 105)
    print(" S20.34 100% VERIFIABLE M5 INTRABAR SEQUENTIAL EXECUTION (STRICT LOT 0.01)")
    print(" Apex Institutional Quantum Matrix | Precision Retest 0.25 | SL-First on Every Bar")
    print("=" * 105)
    ...
    print(f"S20.34 Champion Result | Trades: {trades:3d} | W/BE/L: {wins:3d}/{bes:3d}/{losses:2d} | WR: {wr:4.1f}% | NonLoss: {non_loss:4.1f}% | NetPnL: ${pnl:8.2f} | PF: {pf:6.2f} | MaxDD: ${max_dd:5.2f} | Mos: {pos_m}/{tot_m}")
