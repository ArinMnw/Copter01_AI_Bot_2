...
Display formatted monthly tear sheet for S20.56 from S20_56_monthly.csv.
"""
import pandas as pd
import os, sys
...
if not os.path.exists(csv_path):
    print("CSV not found. Run run_s20_56_m5_verified.py first.")
    sys.exit(1)

df = pd.read_csv(csv_path)
print("=" * 85)
print(" STRATEGY S20.56: OFFICIAL VERIFIED MONTHLY TEAR SHEET (STRICT 0.01 LOT)")
print("=" * 85)
