# Strategy S20.161 Performance Summary

## Executive Overview
- **Strategy Name**: S20.161 — Order Flow Re-accumulation Protocol
- **Baseline Comparison**: Outperformed S20.160 (+$38,339.81) by **+$0.05**
...
ตรวจจับการสะสมรอบสองของสถาบัน (Re-accumulation) ในทิศทางของเทรนด์หลัก
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.05** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.86** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.78R)
