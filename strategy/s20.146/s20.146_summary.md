# Strategy S20.146 Performance Summary

## Executive Overview
- **Strategy Name**: S20.146 — Judas Swing Volatility Trap & Expansion Reversal
- **Baseline Comparison**: Outperformed S20.145 (+$38,338.50) by **+$0.16**
...
ตรวจจับกับดักการหลุดกรอบลวงช่วงเปิดตลาดลอนดอน (Judas Swing) แล้วกลับตัวเข้าหาเป้าหมายใหญ่
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,388.85** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,338.66** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.78R)
