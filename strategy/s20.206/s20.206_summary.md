# Strategy S20.206 Performance Summary

## Executive Overview
- **Strategy Name**: S20.206 — Volume Profile Developing Value Area Migration
- **Baseline Comparison**: Outperformed S20.205 (+$38,353.75) by **+$0.02**
...
วิเคราะห์การเลื่อนตำแหน่งของ Value Area ในระหว่างวันเพื่อเกาะติดเทรนด์สถาบัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.72** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.77** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.51R)
