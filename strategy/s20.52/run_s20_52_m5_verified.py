# -*- coding: utf-8 -*-
"""run_s20_52_m5_verified.py
Official 100% Verifiable Backtest Runner for Strategy S20.52 on Gold (XAUUSD.iux)
...
from strategy20_52 import compute_indicators, extract_setups
...
def main():
    ...
    print(" S20.52 VERIFIABLE M5 SL-FIRST SIMULATION RUNNER (STRICT LOT 0.01)", flush=True)
    ...
    print("Extracting omni-horizon confluences (H4, H3, H2, H1, M30, M20, M15, M12 + Multi-Bar FVG + Strategy 11 Fibo + Strategy 15 VP)...", flush=True)
    base_tfs = [
    ...
    for tf_label, df_tf in base_tfs:
        all_setups.extend(extract_setups(
            df_tf, tf_label,
            min_vol=1.17, min_wick=0.30, retest_depth=0.124,
    ...
    lock16_trig = 6.70; lock16_amt = 6.50
    tp_r = 6.90
    ...
    print("=" * 115, flush=True)
    print(" S20.52 VERIFIED PERFORMANCE SUMMARY (STRICT 0.01 LOT)", flush=True)
    print("=" * 115, flush=True)
    ...
    csv_path = os.path.join(os.path.dirname(__file__), "S20_52_monthly.csv")
