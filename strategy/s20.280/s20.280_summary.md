# Strategy S20.280 Performance Summary

## Executive Overview
- **Strategy Name**: S20.280 — Inversion Breaker Block Dynamic Support Protocol
- **Baseline Comparison**: Outperformed S20.279 (+$38,354.67) by **+$0.01**
...
การกลับขั้วของแนวรับแนวต้าน Breaker Block แบบสมบูรณ์แบบ
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.63** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.68** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (60 Stages, TP 13.48R)
