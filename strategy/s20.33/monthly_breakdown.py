# -*- coding: utf-8 -*-
"""monthly_breakdown.py — Generate detailed monthly tear sheet for S20.33 Champion.
...
def main():
    ...
    csv_path = os.path.join(current_dir, "S20_33_monthly.csv")
    
    monthly_stats = []
    print("\n" + "=" * 95)
    print(" S20.33 TRIPLE-HORIZON INSTITUTIONAL SYNERGY — 365-DAY MONTHLY TEAR SHEET")
