# -*- coding: utf-8 -*-
"""run_s20_49_m5_verified.py
Official 100% Verifiable Backtest Runner for Strategy S20.49 on Gold (XAUUSD.iux)
...
5. Target: Verifiably beat S20.48 (+$25,944.61) and achieve over $26,100+ on strict 0.01 lot!
"""
...
from strategy20_49 import compute_indicators, extract_setups
...
def main():
    ...
    print(" S20.49 VERIFIABLE M5 SL-FIRST SIMULATION RUNNER (STRICT LOT 0.01)", flush=True)
    ...
    print("Extracting omni-horizon confluences (H4, H3, H2, H1, M30, M20, M15, M12 + Multi-Bar FVG + Dual-Session Sweeps)...", flush=True)
    base_tfs = [
    ...
    print("=" * 115, flush=True)
    print(" S20.49 VERIFIED PERFORMANCE SUMMARY (STRICT 0.01 LOT)", flush=True)
    print("=" * 115, flush=True)
    ...
    csv_path = os.path.join(os.path.dirname(__file__), "S20_49_monthly.csv")
