# Strategy S20.149 Performance Summary

## Executive Overview
- **Strategy Name**: S20.149 — Fair Value Void Re-anchoring & Momentum Impulse
- **Baseline Comparison**: Outperformed S20.148 (+$38,339.06) by **+$0.09**
...
ตรวจจับการถมเต็มของ Fair Value Void และการเกิด Momentum Impulse ในทิศทางหลัก
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,389.34** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,339.15** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.76R)
