# Strategy S20.140 Performance Summary

## Executive Overview
- **Strategy Name**: S20.140 — Paradigm 10: Higher-Timeframe Liquidity Magnet Confluence
- **Baseline Comparison**: Outperformed S20.139 (+$38,225.38) by **+$106.72**
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,382.60** |
| **Gross Loss** | **$1,050.50** |
| **Profit Factor** | **37.49** |
| **Net Profit** | **$38,332.10** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (53 Stages, TP 12.80R)
