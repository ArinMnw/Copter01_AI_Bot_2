# Strategy S20.171 Performance Summary

## Executive Overview
- **Strategy Name**: S20.171 — Smart Money Technique (SMT) Relative Strength
- **Baseline Comparison**: Outperformed S20.170 (+$38,340.34) by **+$0.06**
...
การวิเคราะห์แรงส่งเปรียบเทียบของ Smart Money ในระดับโครงสร้างราคา
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.59** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.40** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.61R)
