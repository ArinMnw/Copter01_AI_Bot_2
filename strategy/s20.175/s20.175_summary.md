# Strategy S20.175 Performance Summary

## Executive Overview
- **Strategy Name**: S20.175 — Order Block Mean Threshold (50% MT) Defense
- **Baseline Comparison**: Outperformed S20.174 (+$38,340.55) by **+$0.05**
...
การเข้าเทรดที่ระดับ Mean Threshold 50% ของก้อน Order Block
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.79** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.60** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.58R)
