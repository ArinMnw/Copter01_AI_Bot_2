# Strategy S20.187 Performance Summary

## Executive Overview
- **Strategy Name**: S20.187 — Institutional Micro-Structure Alignment
- **Baseline Comparison**: Outperformed S20.186 (+$38,341.07) by **+$0.06**
...
การจัดระเบียบโครงสร้างราคาตั้งแต่ระดับ Micro สู่ Macro
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.32** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.13** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (58 Stages, TP 13.62R)
