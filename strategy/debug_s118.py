# -*- coding: utf-8 -*-
"""debug_s118.py
Locate progression grid parameters to beat S20.117 ($33,442.01)
"""
...
def main():
    ...
    # Test vsa=1.12, 1.13, 1.14 | wick 0.08 to 0.15 | stages 31, 32, 33 | TP 9.10 to 9.50
    for stg in [stages_31, stages_32, stages_33]:
        for vsa in [1.13, 1.12, 1.14]:
            for wick in [0.10, 0.11, 0.12, 0.09, 0.08]:
                for depth in [0.125, 0.124, 0.126]:
                    ...
                    for tp in [9.15, 9.20, 9.25, 9.30, 9.35, 9.40, 9.50]:
