# -*- coding: utf-8 -*-
"""run_s20_131_m5_verified.py
Official 100% Verifiable Backtest Runner for Strategy S20.131 on Gold (XAUUSD.iux)
"""
...
def main():
    ...
    print(" S20.131 VERIFIABLE M5 SL-FIRST SIMULATION RUNNER (STRICT LOT 0.01)", flush=True)
    print(f" Asset: {symbol_gold} | Period: 365 Days | Execution: Pessimistic Intrabar Sequential M5", flush=True)
    print(f" Paradigm: Paradigm 1: Structural Liquidity Vacuum Compression Confluence", flush=True)
    print("=" * 115, flush=True)
    ...
    stages = [(1.5, 1.0), (2.4, 2.0), (3.0, 2.8), (3.5, 3.3), (3.8, 3.5), (4.2, 3.9), (4.6, 4.3), (5.2, 4.9), (5.5, 5.2), (5.6, 5.4), (5.8, 5.6), (6.0, 5.8), (6.15, 5.95), (6.35, 6.15), (6.5, 6.3), (6.7, 6.5), (6.85, 6.65), (7.0, 6.8), (7.15, 6.95), (7.3, 7.1), (7.45, 7.25), (7.6, 7.4), (7.75, 7.55), (7.9, 7.7), (8.05, 7.85), (8.2, 8.0), (8.35, 8.15), (8.5, 8.3), (8.65, 8.45), (8.8, 8.6), (8.95, 8.75), (9.1, 8.9), (9.25, 9.05), (9.4, 9.2), (9.55, 9.35)]
    res = run_simulation(m5_gold, m5_times, setups, tp_r=11.40, stages=stages)

    print("=" * 115, flush=True)
    print(" S20.131 VERIFIED PERFORMANCE SUMMARY (STRICT 0.01 LOT)", flush=True)
    print("=" * 115, flush=True)
    ...
    pd.DataFrame(monthly_rows).to_csv(os.path.join(os.path.dirname(__file__), "S20_131_monthly.csv"), index=False)
    print(f"Monthly breakdown saved to S20_131_monthly.csv", flush=True)
