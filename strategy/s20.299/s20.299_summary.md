# Strategy S20.299 Performance Summary

## Executive Overview
- **Strategy Name**: S20.299 — The Sovereign Citadel Master Execution 299
- **Baseline Comparison**: Outperformed S20.298 (+$38,355.11) by **+$0.06**
...
ระบบล็อกกำไรขั้นบันไดความแม่นยำสูงก่อนเข้าสู่จุดสูงสุด
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,405.12** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,355.17** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (60 Stages, TP 13.54R)
