# Strategy S20.172 Performance Summary

## Executive Overview
- **Strategy Name**: S20.172 — High-Volume Auction Node Rejection
- **Baseline Comparison**: Outperformed S20.171 (+$38,340.40) by **+$0.04**
...
การปฏิเสธราคาที่ High Volume Node (HVN) ในระบบ Volume Profile
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.63** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.44** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.56R)
