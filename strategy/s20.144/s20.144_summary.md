# Strategy S20.144 Performance Summary

## Executive Overview
- **Strategy Name**: S20.144 — Breaker Block Structural Market Shift Mitigation
- **Baseline Comparison**: Outperformed S20.143 (+$38,338.24) by **+$0.11**
...
ตรวจจับ Breaker Block ที่เกิดจากการทะลุ Swing High/Low ก่อนเกิดการเปลี่ยนโครงสร้างราคา (MSS)
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,388.54** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,338.35** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.72R)
