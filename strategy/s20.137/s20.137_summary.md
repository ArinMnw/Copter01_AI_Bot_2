# Strategy S20.137 Performance Summary

## Executive Overview
- **Strategy Name**: S20.137 — Paradigm 7: Inversion Fair Value Gap (IFVG) & Polarity Reversal Confluence
- **Baseline Comparison**: Outperformed S20.136 (+$38,169.30) by **+$37.17**
...
| **Losses** | **437 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,264.13** |
| **Gross Loss** | **$1,057.66** |
| **Profit Factor** | **37.12** |
| **Net Profit** | **$38,206.47** |
| **Max Drawdown** | **$16.78** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (43 Stages, TP 11.95R)
