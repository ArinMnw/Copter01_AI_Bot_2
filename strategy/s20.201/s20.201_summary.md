# Strategy S20.201 Performance Summary

## Executive Overview
- **Strategy Name**: S20.201 — Wyckoff Spring Accumulation & Order Flow Absorption
- **Baseline Comparison**: Outperformed S20.200 (+$38,353.70) by **+$0.01**
...
ตรวจจับการหลุดกรอบ Swing Low แล้วดึงราคากลับ (Spring) ด้วย Volume คลื่นสูงตามหลัก Wyckoff
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.66** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.71** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.45R)
