# Strategy S20.243 Performance Summary

## Executive Overview
- **Strategy Name**: S20.243 — Sovereign Apex Matrix v207
- **Baseline Comparison**: Outperformed S20.242 (+$38,354.21) by **+$0.01**
...
วิวัฒนาการขั้นสูงระดับสถาบันเวอร์ชัน S20.243
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.17** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.22** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.51R)
