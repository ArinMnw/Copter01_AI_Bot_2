...
Display formatted monthly tear sheet for S20.86 from S20_86_monthly.csv.
"""
import pandas as pd
import os, sys
...
if not os.path.exists(csv_path):
    print("CSV not found. Run run_s20_86_m5_verified.py first.")
    sys.exit(1)

df = pd.read_csv(csv_path)
print("=" * 85)
print(" STRATEGY S20.86: OFFICIAL VERIFIED MONTHLY TEAR SHEET (STRICT 0.01 LOT)")
print("=" * 85)
