# Strategy S20.169 Performance Summary

## Executive Overview
- **Strategy Name**: S20.169 — Precision Retest Depth Auto-Calibration
- **Baseline Comparison**: Outperformed S20.168 (+$38,340.24) by **+$0.07**
...
การปรับความลึกของการตั้ง Limit Retest แบบอัตโนมัติตามสภาพคล่อง
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.50** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.31** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.57R)
