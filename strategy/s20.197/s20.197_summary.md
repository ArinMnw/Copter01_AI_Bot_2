# Strategy S20.197 Performance Summary

## Executive Overview
- **Strategy Name**: S20.197 — SMT Session Divergence Alignment
- **Baseline Comparison**: Outperformed S20.196 (+$38,341.69) by **+$0.11**
...
การยืนยันสัญญาณไดเวอร์เจนซ์ของเซสชันระดับสถาบัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,391.99** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,341.80** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (60 Stages, TP 13.65R)
