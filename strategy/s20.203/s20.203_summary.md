# Strategy S20.203 Performance Summary

## Executive Overview
- **Strategy Name**: S20.203 — Breaker Block & FVG Consequent Encroachment (50% CE)
- **Baseline Comparison**: Outperformed S20.202 (+$38,353.72) by **+$0.01**
...
เข้าเทรดที่จุดกึ่งกลาง 50% Consequent Encroachment ของ Fair Value Gap ร่วมกับ Breaker Block
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.68** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.73** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.50R)
