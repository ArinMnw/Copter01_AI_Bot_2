# Strategy S20.165 Performance Summary

## Executive Overview
- **Strategy Name**: S20.165 — Volatility Regime Switching Algorithm
- **Baseline Comparison**: Outperformed S20.164 (+$38,340.03) by **+$0.06**
...
ระบบสลับโหมดการเทรดตามสภาวะความผันผวนของตลาดทองคำ
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.28** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.09** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.57R)
