# -*- coding: utf-8 -*-
"""strategy20_302.py
Strategy S20.302: Non-Conflicting Multi-Session Architecture

Core Innovations:
1. แนวทางที่ 2: สถาปัตยกรรมแยกพฤติกรรมเจ้ามือ 3 เซสชัน (Asian Judas, London Sweep, NY Injection) ปรับ SL Buffer รับสภาพคล่อง
...
CONFIG = {
    "version": "S20.302",
    "name": "Non-Conflicting Multi-Session Architecture",
