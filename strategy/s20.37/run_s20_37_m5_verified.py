# -*- coding: utf-8 -*-
"""run_s20_37_m5_verified.py
Official 100% Verifiable Backtest Runner for Strategy S20.37 on Gold (XAUUSD.iux)
...
5. Target: Verifiably beat S20.36 (+$7,663.53)
"""
...
def main():
    ...
    print(" S20.37 VERIFIABLE M5 SL-FIRST SIMULATION RUNNER (STRICT LOT 0.01)", flush=True)
    ...
    # Simulation parameters (Penta-Stage Ratchet Trailing)
    be_trigger = 0.8
    lock1_trig = 1.5
    lock1_amt = 1.0
    lock2_trig = 2.4
    ...
    print("\n" + "=" * 115, flush=True)
    print(" 🏆 FINAL VERIFIED PERFORMANCE — STRATEGY S20.37 (STRICT LOT 0.01)", flush=True)
    print("=" * 115, flush=True)
    ...
    csv_path = os.path.join(os.path.dirname(__file__), "S20_37_monthly.csv")
