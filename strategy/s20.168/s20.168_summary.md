# Strategy S20.168 Performance Summary

## Executive Overview
- **Strategy Name**: S20.168 — Multi-Day Range Expansion Wave
- **Baseline Comparison**: Outperformed S20.167 (+$38,340.19) by **+$0.05**
...
การวิ่งตามรอบคลื่นการขยายตัวของกรอบราคาระดับหลายวัน
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,390.43** |
| **Gross Loss** | **$1,050.19** |
| **Profit Factor** | **37.51** |
| **Net Profit** | **$38,340.24** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (55 Stages, TP 13.59R)
