# Strategy S20.247 Performance Summary

## Executive Overview
- **Strategy Name**: S20.247 — Sovereign Apex Matrix v211
- **Baseline Comparison**: Outperformed S20.246 (+$38,354.26) by **+$0.01**
...
วิวัฒนาการขั้นสูงระดับสถาบันเวอร์ชัน S20.247
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,404.22** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,354.27** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (57 Stages, TP 13.52R)
