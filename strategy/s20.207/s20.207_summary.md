# Strategy S20.207 Performance Summary

## Executive Overview
- **Strategy Name**: S20.207 — Cumulative Volume Delta (CVD) Absorption Divergence
- **Baseline Comparison**: Outperformed S20.206 (+$38,353.77) by **+$0.01**
...
ผสานสัญญาณไดเวอร์เจนซ์ของ Volume Delta กับการดูดซับสภาพคล่องอย่างรุนแรง
...
| **Losses** | **434 (9.8%)** |
| **Non-Loss Rate** | **90.2%** |
| **Gross Profit** | **$39,403.73** |
| **Gross Loss** | **$1,049.95** |
| **Profit Factor** | **37.53** |
| **Net Profit** | **$38,353.78** |
| **Max Drawdown** | **$16.63** |
| **Winning Months** | **13/13 (100.0%)** |

## Trailing Architecture (56 Stages, TP 13.48R)
