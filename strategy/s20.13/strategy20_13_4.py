...
def strategy_20_13_4(rates, tf="H1"):
    ...
    # IDEA 4: Volume Increase Filter
    # Engulfing bar should have more tick volume than the previous bar to confirm participation
    vol_increase = current_bar['tick_volume'] > prev_bar['tick_volume']
    ...
    if (sweep_buy and engulf_buy) or instant_sweep_buy:
        ...
        if not vol_increase:
            return {"signal": "WAIT", "reason": "No Volume Increase"}
        if is_london_open:
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.4 PA Confirmed BUY",
            "reason": f"Sweep {local_low:.2f} | Range+Vol | TP {tp:.2f}"
        }
    ...
    if (sweep_sell and engulf_sell) or instant_sweep_sell:
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.4 PA Confirmed SELL",
            "reason": f"Sweep {local_high:.2f} | Range+Vol | TP {tp:.2f}"
        }
