...
def evaluate_bar(df, idx, tf="H1"):
    ...
    if (sweep_buy and engulf_buy) or instant_sweep_buy:
        ...
        # v20 Evolution BUY Filters (365-Day High Precision Traps)
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.20 PA Confirmed BUY",
    ...
    if (sweep_sell and engulf_sell) or instant_sweep_sell:
        ...
        # v19 Evolution SELL Filters (Zero Loss Target)
        ...
        # v20 Evolution SELL Filters (365-Day High Precision Traps)
