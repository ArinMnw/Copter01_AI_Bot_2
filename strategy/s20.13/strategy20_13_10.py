...
def strategy_20_13_10(rates, tf="H1"):
    ...
    if (sweep_buy and engulf_buy) or instant_sweep_buy:
        ...
        # IDEA 10: Minimum Sweep Depth (Trap Size)
        sweep_depth = local_low - sweep_bottom
        if sweep_depth < (0.3 * current_bar['atr']):
            return {"signal": "WAIT", "reason": "Sweep Depth too shallow (< 0.3 ATR)"}
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.10 PA Confirmed BUY",
            "reason": f"Sweep {local_low:.2f} | Trap Size {sweep_depth:.1f} | TP {tp:.2f}"
        }
    ...
    if (sweep_sell and engulf_sell) or instant_sweep_sell:
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.10 PA Confirmed SELL",
            "reason": f"Sweep {local_high:.2f} | Trap Size {sweep_depth:.1f} | TP {tp:.2f}"
        }
