...
def strategy_20_13_3(rates, tf="H1"):
    ...
    # IDEA 3: Engulfing Range ATR Filter
    ...
    if (sweep_buy and engulf_buy) or instant_sweep_buy:
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.3 PA Confirmed BUY",
            "reason": f"Sweep {local_low:.2f} | Range ATR | TP {tp:.2f}"
        }
    ...
    if (sweep_sell and engulf_sell) or instant_sweep_sell:
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.3 PA Confirmed SELL",
            "reason": f"Sweep {local_high:.2f} | Range ATR | TP {tp:.2f}"
        }
