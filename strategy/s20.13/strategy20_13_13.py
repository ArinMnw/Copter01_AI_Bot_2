...
def strategy_20_13_13(rates, tf="H1"):
    ...
    if (sweep_buy and engulf_buy) or instant_sweep_buy:
        ...
        # IDEA 13: NO TREND FILTER (Buy anywhere as long as sweep & RSI OK)
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.13 PA Confirmed BUY",
            "reason": f"Sweep {local_low:.2f} | No Trend Filter | TP {tp:.2f}"
        }
    ...
    if (sweep_sell and engulf_sell) or instant_sweep_sell:
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.13 PA Confirmed SELL",
            "reason": f"Sweep {local_high:.2f} | No Trend Filter | TP {tp:.2f}"
        }
