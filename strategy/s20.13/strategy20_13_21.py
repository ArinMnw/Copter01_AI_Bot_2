...
def evaluate_bar(df, idx, tf="H1"):
    ...
    if (sweep_buy and engulf_buy) or instant_sweep_buy:
        ...
        # v21 Evolution BUY Filters (Deep Precision Traps - 87.27% WR Target)
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.21 PA Confirmed BUY",
    ...
    if (sweep_sell and engulf_sell) or instant_sweep_sell:
        ...
        # v21 Evolution SELL Filters (Deep Precision Traps - 87.27% WR Target)
