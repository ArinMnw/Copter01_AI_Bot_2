...
buy_replace = '''        if current_bar['rsi'] < 35:
        ...
        if cur_range > 0 and lower_wick / cur_range < 0.10:
            return {"signal": "WAIT", "reason": "Weak Lower Wick (BUY)"}'''
...
sell_replace = '''        if current_bar['rsi'] > 60:
        ...
        if cur_range > 0 and upper_wick / cur_range < 0.10:
            return {"signal": "WAIT", "reason": "Weak Upper Wick (SELL)"}'''
