...
def inspect_buy_unlocked(days=700, symbol="XAUUSD.iux"):
    ...
    target_cats = ["BUY Low Volatility Drift Block", "BUY Trend/Z Block", "RSI too low", "BUY Trend Exhaustion Block"]
