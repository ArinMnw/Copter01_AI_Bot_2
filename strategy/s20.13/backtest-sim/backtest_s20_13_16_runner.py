...
from strategy20_13_16 import strategy_20_13_16
    ...
    for period in periods:
        ...
        for tf_name in tf_list:
            ...
            for i in range(100, len(rates) - 1):
                slice_rates = rates[:i]
                res = strategy_20_13_16(pd.DataFrame(slice_rates), tf=tf_name)
                if res.get("signal") in ["BUY", "SELL"]:
                    ...
                    sd16_dist = tp_dist * (1.5 / 2.6)
                    if signal == "BUY":
                        be_trigger = entry + sd16_dist
                    else:
                        be_trigger = entry - sd16_dist
        ...
        if all_trades_log:
            ...
            df_trades.to_csv('s20_13_16_trades.csv', index=False)
