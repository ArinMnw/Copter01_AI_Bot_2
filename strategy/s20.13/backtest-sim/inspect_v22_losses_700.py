...
def inspect_v22_700(days=700, symbol="XAUUSD.iux"):
    ...
    print("\n--- ALL 17 REMAINING LOSSES IN V22 (700 DAYS) ---")
    ...
    df_trades.to_csv('v22_700d_all_trades_features.csv', index=False)
    print("\nSaved all trades with features to v22_700d_all_trades_features.csv")
    mt5.shutdown()
