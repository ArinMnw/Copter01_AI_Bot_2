...
from strategy20_13_2 import strategy_20_13_2
    ...
    for period in periods:
        ...
        for tf_name in tf_list:
            ...
            for i in range(100, len(rates) - 1):
                slice_rates = rates[:i]
                res = strategy_20_13_2(slice_rates, tf=tf_name)
        ...
        print(f"| **สรุปรวมทุก TF** | {total_trades} | {total_wins} | {total_losses} | {total_win_rate:.2f}% | MIX | {total_pnl_str} |")
