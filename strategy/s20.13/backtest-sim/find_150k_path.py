...
def find_path(days=700, symbol="XAUUSD.iux", compound=1.5):
    ...
    # Let's test relaxing/removing older filters one by one!
    # Let's first inspect all potential setups without ANY v18-v22 SELL filters!
    
    print("Evaluating baseline base setups without older restrictive SELL filters...")
