...
sys.path.append(os.path.join(os.path.dirname(__file__), ".."))
from strategy20_13_18 import strategy_20_13_18
    ...
    for period in periods:
        ...
        for tf_name in tf_list:
            ...
            for i in range(100, len(rates) - 1):
                slice_rates = rates[:i]
                res = strategy_20_13_18(pd.DataFrame(slice_rates), tf=tf_name)
        ...
        if all_trades_log:
            ...
            df_trades.to_csv('s20_13_18_trades.csv', index=False)
