...
buy_replace = '''        if current_time.hour in (8, 9, 12, 22):
            return {"signal": "WAIT", "reason": "Bad Hour Trap (BUY)"}'''
...
sell_replace = '''        if current_time.hour in (8, 9, 12, 22):
            return {"signal": "WAIT", "reason": "Bad Hour Trap (SELL)"}'''
