...
def strategy_20_13_9(rates, tf="H1"):
    ...
    # IDEA 9: Strong Engulfing Body Filter
    cur_body = abs(current_bar['close'] - current_bar['open'])
    is_strong_body = cur_body >= (0.5 * current_bar['atr'])
    ...
    if (sweep_buy and engulf_buy) or instant_sweep_buy:
        if not is_strong_body:
            return {"signal": "WAIT", "reason": "Engulfing Body < 0.5 ATR"}
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.9 PA Confirmed BUY",
    ...
    if (sweep_sell and engulf_sell) or instant_sweep_sell:
        ...
        return {
            ...
            "sl": sl,
            "tp": tp,
            "pattern": "S20.13.9 PA Confirmed SELL",
