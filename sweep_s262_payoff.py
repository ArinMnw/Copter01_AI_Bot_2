# -*- coding: utf-8 -*-
"""Fast exact payoff and breakeven sweep for S262."""
...
from strategy262 import detect_s262
from sweep_s235_payoff import _summary_market


RR_VALUES = (27.0, 27.1)
BE_VALUES = tuple(round(0.07 + 0.01 * index, 2) for index in range(64))
...
def main():
    ...
    for index in range(start_index, len(bars) - 1):
        ...
        signal = detect_s262(window, "M5", dt_bkk, base_cfg)
        validate_signal(signal, 262)
        cached[index] = signal
    rows = [
