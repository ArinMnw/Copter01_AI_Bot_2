# -*- coding: utf-8 -*-
"""Final cross-window, spread, and payload falsification audit for S397."""

from datetime import datetime

from sim_strategy_backtest import backtest, parse_bkk, prepare_rates
from strategy397 import detect_s397
    ...
    for name, months, end_text in WINDOWS:
        ...
        for spread in (0.20, 0.50):
            summary, trades = backtest(
                397, months, "M5", spread, 0.01, end, 300, prepared=prepared
            )
            print(name, spread, {key: summary[key] for key in SUMMARY_KEYS}, flush=True)
            if spread == 0.20:
