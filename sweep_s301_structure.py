# -*- coding: utf-8 -*-
"""Cached KS/median-shift threshold sensitivity for S301 SELL signals."""
...
def main():
    ...
    parser.add_argument(
        "--ks-values",
        default="0,0.50,0.75,1.00,1.15,1.25,1.50,1.75",
    )
    parser.add_argument(
        "--shift-values",
        default="0,0.20,0.40,0.60,0.80,1.00,1.20",
    )
        ...
        for shift_min in shift_values:
            ...
            for index, signal in raw.items():
                ...
                cached[index] = (
                    ...
                    else _wait("Filtered by S301 threshold sensitivity")
                )
