...
parser = argparse.ArgumentParser(description="Backtest S111 Gap Magnet")
parser.add_argument("--days", type=int, default=90)
parser.add_argument("--start", type=str, help="YYYY-MM-DD")
parser.add_argument("--end", type=str, help="YYYY-MM-DD")
parser.add_argument("--fill-bars", type=int, default=144, help="For limit entry mode")
parser.add_argument("--cooldown", type=int, default=10)
parser.add_argument("--tf", type=str, default="M5")
parser.add_argument("--out-prefix", type=str, default="s111")
