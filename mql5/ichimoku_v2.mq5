//+------------------------------------------------------------------+
//|                                                 ichimoku_v2.mq5   |
//|  Ichimoku Cloud v2 (แปลงจาก Pine Script v6 "Ichimoku Cloud")      |
//|  ⚠️ v2: signal Sell/Buy ตัดเงื่อนไข Lead A/Lead B ออก              |
//|         เหลือแค่ Lag vs Conversion/Base เท่านั้น (เส้น Cloud ยัง   |
//|         วาดอยู่ปกติ แค่ไม่ใช้ filter สัญญาณ)                       |
//|                                                                     |
...
//+------------------------------------------------------------------+
// เงื่อนไข Sell/Buy (v2 — ตัดเงื่อนไข Lead A/Lead B ออก เหลือแค่ Lag/Conversion/Base)
