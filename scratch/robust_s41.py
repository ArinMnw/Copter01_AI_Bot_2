...
cfg.update(PIVOT_WING=2, MIN_PRICE_DIFF_ATR=0.3, MIN_RSI_DIFF=3.0, MAX_CONFIRM_AGE_BARS=8,
           SL_ATR_MULT=0.8, TP_RR=1.0, CONFIRMATION_TYPE="htf_trend")

print(f"config: wing=2 pd=0.3 rd=3.0 ca=8 sl=0.8 rr=1.0 ct=htf_trend")
