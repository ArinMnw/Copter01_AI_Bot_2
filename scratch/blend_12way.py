...
for days in [60, 90, 120, 150, 180]:
    ...
    total_11, c_11 = combine(list("abcdefghikl"))
    total_12, c_12 = combine(list("abcdefghiklm"))

    print(f"--- {days}d ---")
    print(f"  11-way เดิม: $/mo={total_11/days*30:7.1f} posDay={c_11['pct_pos_days']:5.1f}% "
          f"maxStreak={c_11['max_losing_day_streak']:2}d sharpe={c_11['sharpe_like']:6.3f}")
    print(f"  12-way (+M): $/mo={total_12/days*30:7.1f} posDay={c_12['pct_pos_days']:5.1f}% "
