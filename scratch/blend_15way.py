...
cfgs = {"a": cfg_a, "b": cfg_b, "c": cfg_c, "d": cfg_d, "e": cfg_e, "f": cfg_f, "g": cfg_g,
        "h": cfg_h, "i": cfg_i, "k": cfg_k, "l": cfg_l, "m": cfg_m, "n": cfg_n, "p": cfg_p}
...
for days in [60, 90, 120, 150, 180]:
    ...
    total_14, c_14 = combine(list("abcdefghiklmnp"))
    ...
    print(f"  14-way (+P): $/mo={total_14/days*30:7.1f} posDay={c_14['pct_pos_days']:5.1f}% "
