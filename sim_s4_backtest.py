    ...
    return [
        {
            ...
            "runtime": "apply",
            "replay": "apply",
            "note": "Replay calls shared strategy4.strategy_4()",
        },
        {
        ...
        },
        {
            ...
            "runtime": "apply",
            "replay": "gap",
            "note": "Runtime applies PD Fibo Plus to S4 pending/fill",
        },
        {
            ...
            "runtime": "apply",
            "replay": "gap",
            "note": "Runtime applies trend recheck to S4 pending/fill",
        },
        {
            ...
            "runtime": "apply",
            "replay": "gap",
            "note": "Runtime can close S4 after fill when RSI recheck fails",
        },
        {
            ...
            "runtime": "apply",
            "replay": "gap",
            "note": "Shared lifecycle features are not included in S4 baseline yet",
        },
    ]
...
def backtest_tf(tf_name: str, tf_val: int) -> list[dict]:
    ...
    for i in range(start_idx, len(bars)):
        ...
        result = strategy_4(scan_rates, tf=tf_name)
