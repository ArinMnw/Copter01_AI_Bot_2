...
S14_RSI_DIV_ENABLED   = True    # เปิด/ปิดการตรวจจับ RSI Divergence สำหรับ S14 (default True)
...
PDFIBOPLUS_SKIP_SIDS = {1, 2, 3, 9, 10, 11, 13, 14, 15, 16, 17, 18, 19}
...
def restore_runtime_state():
    ...
    try:
        ...
        global TREND_FILTER_SCAN_BLOCK, PDFIBOPLUS_ENABLED, RECHECK_COMBINED_MODE
        ...
        S20_ENABLED = bool(state.get("s20_enabled", False))
