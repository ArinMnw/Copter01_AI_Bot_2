# -*- coding: utf-8 -*-
"""Final reproducible cross-window, spread, and payload audit for S405."""

from datetime import datetime

from sim_strategy_backtest import backtest, parse_bkk, prepare_rates
from strategy405 import detect_s405
    ...
    for name, months, end_text in WINDOWS:
        ...
        for spread in (0.20, 0.50):
            summary, trades = backtest(
                405, months, "M5", spread, 0.01, end, 300, prepared=prepared
            )
