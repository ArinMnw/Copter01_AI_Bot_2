# -*- coding: utf-8 -*-
"""Final reproducible cross-window, spread, and payload audit for S396."""

from datetime import datetime

from sim_strategy_backtest import backtest, parse_bkk, prepare_rates
from strategy396 import detect_s396
    ...
    for name, months, end_text in WINDOWS:
        ...
        for spread in (0.20, 0.50):
            summary, trades = backtest(
                396, months, "M5", spread, 0.01, end, 300, prepared=prepared
            )
