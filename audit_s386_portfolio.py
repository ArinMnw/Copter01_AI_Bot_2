# -*- coding: utf-8 -*-
"""Parallel overlap, risk-distance, and portfolio audit for S386."""
...
def main():
    by_sid = {sid: [] for sid in (*BASE_IDS, 386)}
    h1_trades = {}
    risks = []
    ...
    target_times = {trade["signal_time"] for trade in h1_trades[386]}
    overlap = {
