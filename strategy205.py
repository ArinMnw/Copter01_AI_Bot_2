# -*- coding: utf-8 -*-
"""S205 - Kurtosis, variance-ratio, and bipower-jump triple confluence sweep reclaim, 16.9R."""
...
def detect_s205(rates, tf, dt_bkk, cfg):
    ...
    return {
        ...
        "tp": tp,
        "order_type": "limit",
        "pattern": f"S205 {signal} Triple Confluence Sweep {rr:g}R",
        "reason": (f"Kurt={kurtosis:.2f}, VR={variance_ratio:.2f}, "
                   f"jump={jump_score:.2f}; structural sweep reclaimed"),
        "be_rr": float(c["BE_RR"]),
