...
หมายเหตุ:
- **Skip**: `sid in (1, 9, 11, 14, 15, 16, 17, 18, 19)` — S1/S11 ใช้ zone/fibo หลัก, S9/S15/S17 เป็น counter/extreme design, S14/S18/S19 เป็น standalone, S16 skip ตาม runtime ปัจจุบัน
- S10 และ S13 ยังเข้า RSI Fill Recheck ถ้า `PENDING_RSI_RECHECK_ENABLED=True`
...
- **Skip**: `sid in (1, 2, 3, 9, 10, 11, 14, 15, 16, 17, 18, 19)`
- **Apply**: S4, S5, S6, S8, S12, S13
...
Skip ปัจจุบัน: `config.PDFIBOPLUS_SKIP_SIDS = {1, 2, 3, 9, 10, 11, 13, 14, 15, 16, 17, 18, 19}` ใช้ร่วมกันทั้ง pre-create, pending recheck และ fill check

Apply ปัจจุบัน: S4, S5, S6, S8, S12
