# -*- coding: utf-8 -*-
"""Exact cached payoff and breakeven sweep for S289."""
...
from strategy289 import detect_s289
...
def main():
    ...
    for index in range(start_index, len(bars) - 1):
        ...
        signal = detect_s289(window, "M5", dt_bkk, base_cfg)
        validate_signal(signal, 289)
        cached[index] = signal
    rr_values = RR_VALUES
    be_values = BE_VALUES
    if args.rr_values:
