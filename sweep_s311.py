# -*- coding: utf-8 -*-
"""Exact cached payoff/BE sweep for S311 SELL market signals."""
...
RR_VALUES = tuple(round(7.0 + 0.5 * index, 1) for index in range(47))
...
def main():
    ...
    parser.add_argument("--end", default="2026-07-20T00:00:00+07:00")
    ...
    for index in range(start_index, len(bars) - 1):
        ...
        signal = detect_s311(window, "M5", dt_bkk, base_cfg)
